      ...
      <div className="grid min-h-[calc(100vh-2rem)] gap-4 xl:grid-cols-[1fr_290px]">
              ...
              <div className="rounded-[1.7rem] border border-brass-500/16 bg-black/28 p-4 shadow-copper backdrop-blur-xl">
                <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <h2 className="font-display text-3xl text-brass-50">{enemy.name}</h2>
                  </div>
          ...
          <section className="rounded-[1.7rem] border border-brass-700/30 bg-[radial-gradient(circle_at_center,rgba(216,138,99,0.08),transparent_48%),linear-gradient(180deg,rgba(0,0,0,0.18),rgba(0,0,0,0.3))] p-4 shadow-insetPanel backdrop-blur-xl">
            <div className="grid gap-4 lg:grid-cols-[1fr_280px] lg:items-center">
              <div>
                ...
                <h3 className="mt-1 font-display text-3xl text-brass-50">Arena de combate</h3>
              ...
              <div className="rounded-[1.35rem] border border-copper-400/15 bg-black/30 p-3">
                ...
                <button type="button" onClick={() => onTarget({ type: "player", id: enemy.id, owner: "enemy" })} disabled={turn !== "player" || !selectedAttackerId} className="mt-2.5 w-full rounded-[1rem] border border-brass-100/12 bg-white/5 px-4 py-2.5 text-[10px] font-semibold uppercase tracking-[0.28em] text-brass-50 disabled:opacity-40">
                  Ataque Direto
                </button>
              </div>
            </div>
            <div className="mt-4 h-10 rounded-[1.2rem] border border-brass-200/8 bg-[linear-gradient(90deg,rgba(255,255,255,0.02),rgba(216,138,99,0.08),rgba(255,255,255,0.02))]" />
          </section>
            ...
            <div className="rounded-[1.7rem] border border-brass-500/16 bg-black/28 p-4 shadow-copper backdrop-blur-xl">
              <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <h2 className="font-display text-3xl text-brass-50">{player.name}</h2>
                </div>
                <div className="rounded-[1.1rem] border border-brass-100/12 bg-white/[0.04] px-4 py-2.5 text-right text-[10px] uppercase tracking-[0.26em] text-brass-100/58">
                  Mao Atual
        ...
        <aside className="grid auto-rows-min gap-4">
          <div className="rounded-[1.6rem] border border-brass-700/30 bg-black/30 p-4 shadow-insetPanel backdrop-blur-xl">
            ...
            <p className="mt-1 font-display text-xl text-brass-50">Leituras da Caldeira</p>
